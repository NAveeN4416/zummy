      ...
      <div class="col-sm-12">
        ...
        <div class="main-header">
          ...
          <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
            ...
            <li class="breadcrumb-item"><a href="#:" >Add/Edit Categories</a></li>
    ...
    <div class="row">
      ...
      <div class="col-sm-12">
        ...
        <div class="card">
          ...
          <div class="card-header"><h5 class="card-header-text">Add/Edit Categories</h5>
             <span><button class="btn btn-success fa fa-plus add_category" data-name="<?php echo @$current_page; ?>" style="margin-left:69%"> Category </button></span> 
                      ...
                      foreach($categories as $category) {
                          ...
                          if ($category["status"] == "1") {
                              ...
                              <tr id="hide<?php echo $category["id"] ; ?>">
                                  ...
                                  <td style="width:300px;"><?php echo ucfirst($category["name_en"]) ; ?></td> 
                                   ...
                                   <td style="white-space: nowrap; width: 1%;">
                                    ...
                                    <div class=" user-toolbar btn-toolbar" style="text-align: left;">
                                        ...
                                        <div class="btn-group btn-group-sm" style="float: none;">
                                            ...
                                            <button type="button" class="btn btn-primary waves-effect waves-light delete_categories" data-id="<?php echo $category["id"] ; ?>" style="float: none;margin: 5px;"> 
   ...
   <script>     
    ...
    { 
          ...
          var id = $(this).data('id');
              ...
              swal({title: 'Delete This Category ?', showCancelButton: true}).then(result => {
                if (result.value) 
                {
                ...
                {
                         $.ajax({                
                              url: "<?php echo base_url();?>admin/delete/categories",
                              type: "POST",
                              data: {id:id},
