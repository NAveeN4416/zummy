    ...
    <div class="modal-content" style="overflow:hidden">
        ...
        <div class="modal-body">
           ...
           <div class="form-group">
             <label for="example-tel-input" class="col-xs-4 col-form-label form-control-label">Category Name En</label>
            <div class="col-sm-8">
                <input type="text" id="name_en"  name="data[name_en]"  class="form-control" value="<?php echo @$category['name_en'];?>">
         ...
         <div class="form-group row">
           ...
           <div class="form-group">
             <label for="example-tel-input" class="col-xs-4 col-form-label form-control-label">Category Name Ar</label>
            <div class="col-sm-8">
                <input type="text" id="name_ar"  name="data[name_ar]"  class="form-control" value="<?php echo @$category['name_ar'];?>">
          ...
          <div class="form-group row">
                ...
                <?php  if(@$category){ ?>
           <img src="<?php echo base_url();?><?php echo @$category['image'];?>" height=100px;>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                    ...
                    <select class="form-control" name="data[status]">
                      ...
                      <option value="1" <?php if(isset($category['status'])) { if($category['status'] == "1"){ echo "selected";}}  else { echo "selected"; } ?>>Active</option>

                      <option value="0" <?php if(isset($category['status'])) { if($category['status'] == "0"){ echo "selected";}} ?>>InActive</option>
                </select>
        ...
        var validator = $("#insert_categories").validate();
            ...
            if(validator.form() == true){
                ...
                $.ajax({                
                    ...
                    url: "<?php echo base_url();?>admin/save_data/categories",
