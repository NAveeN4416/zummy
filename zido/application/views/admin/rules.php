    ...
    <div class="row">
      ...
      <div class="col-sm-12">
        ...
        <div class="card">
          ...
          <div class="card-header"><h5 class="card-header-text">Engineering Rules Management</h5></div>
          ...
          <div class="card-block">
              ...
              <form id="insert_services">                         
                 ...
                 <div class="form-group row">
                    ...
                    <label for="example-tel-input" class="col-xs-3 col-form-label form-control-label">Rules Content(En)*</label>
