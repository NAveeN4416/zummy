    ...
    <div class="row">
      ...
      <div class="col-sm-12">
        ...
        <div class="card">
          ...
          <div class="card-header"><h5 class="card-header-text">Careers</h5></div>
          ...
          <div class="card-block">
              ...
              <form id="insert_services">                         
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text"  id="title_en" name="data[title_en]"  class="form-control"  value="<?php echo @$contact_us['title_en'];?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="example-tel-input" class="col-xs-3 col-form-label form-control-label">Title (Ar)*</label>
                    <div class="col-sm-9">
                        <input type="text"  id="title_ar" name="data[title_ar]" class="form-control"  value="<?php echo @$contact_us['title_ar'];?>">
                    </div>
                </div>
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <textarea  id="content_en" name="data[content_en]"  class="form-control ckeditor" ><?php echo @$contact_us['content_en'];?></textarea>
                    </div>
                </div>
