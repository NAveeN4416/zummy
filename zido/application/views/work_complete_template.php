...
<body style='font-family: 'Open Sans',sans-serif; margin:0px auto; font-size:15px; width:100%;''>
  ...
  <div class='main-div'  style='width: 60%;margin:20px auto; height:auto;border: 1px solid #ccc;'>
    <div class='content' style='width:100%; margin:0px auto;'>
      <div class='top-header' style='width: 100%;padding-bottom: 100px;padding-top: 10px;background: #00B0D4;border-bottom: 1px solid #ccc;'>
        <div class='logo' style=' float:left; width:22%'> <a href='https://www.volive.in/aous'>
          <img src='http://volive.in/aous/assets/images/logo.png' alt='logo' style='width:110px !important;margin-left: 10px;'></a> </div>
          <div class='header-content' style=' float:left; width:70%'>
            <p style='margin-bottom: 0px;font-size: 25px;color: #fff;font-weight: 600;line-height: 18px;margin-top: 34px;  text-transform: uppercase;text-align: center;'>AOUS</p>
          </div>
        </div>
        ...
        <div class='content' style='width:81%;padding: 15px 20px;'>
          ...
          <p style='margin-top:28px; margin-bottom:28px;width:90%;margin-top: 13px;'>
            ...
            <p>Thank you for using AOUS App.</p>
          </p>
        </div>

        
        <div style='background-color: #ddd; padding: 2px 20px;'>
          <p><a href='https://www.volive.in/aous' style='font-size:13px;font-weight:bold;width:90%;'>Any questions ? Feel free to Contact us</a></p>
          <p><a href="https://www.volive.in/aous">AOUS.com</a></p>
        </div>
      </div>
    </div>
  </body>
