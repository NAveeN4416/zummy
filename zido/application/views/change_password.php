...
<head>
	...
	<link rel="icon" href="<?php echo base_url();?>assets/frontend/img/logo.png" tppabs="http://ableproadmin.com/light/vertical/assets/images/favicon.ico" type="image/x-icon">
				...
				<div class="login-card card-block">
					...
					<span  id="forgot_msg"> </span>
						...
						<div class="text-center">
							<img src="<?php echo base_url();?>assets/frontend/img/logo.png" style="width:80px;">
						</div>
						<h3 class="text-center txt-primary">
						 Hello <?php echo $user->username; ?><br><br>
					...
					<span  id="login_error_msg"> </span>
						...
						<input type="hidden" value="<?php echo base64_encode($user->id) ; ?>" name="data[user_id]">
